...
import { FlatList, Platform, RefreshControl, ScrollView, StyleSheet, TouchableOpacity, useWindowDimensions, View } from "react-native";
...
export default function CatalogIndex({ }: Props) {
    ...
    const headerBorderTopStyle = useAnimatedStyle(() => {
        'worklet';
        return {
            borderTopColor: interpolateColor(scrollY.value, [0, categoryTop - headerHeight, categoryTop], [colors.gray[300], colors.gray[300], 'rgba(0,0,0,0)'])
        }
    }, [])
        ...
        <Box flex bg={colors.white}>
            ...
            >
                <Box row flex={{ items: "center" }} >
                    ...
                    <TouchableOpacity>
                        <Box center border={{ radius: 100 }} height={40} w={40} >
            ...
            <ReanimatedFlatList
                ...
                data={sectionData}
                contentContainerStyle={{ paddingTop: width * 0.5 - headerHeight }}
